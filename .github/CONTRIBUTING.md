...
# Contributing to SSO Enterprise Service

Thank you for your interest in contributing to **SSO Enterprise Service**!  
...
**SSO Enterprise Service** is an open-source SSO Service licensed under **MIT**, with both:
...
We follow a [Code of Conduct](https://github.com/skygenesisenterprise/sso-service/CODE_OF_CONDUCT.md) to ensure a safe, respectful, and inclusive environment.  
...
Open a [GitHub Discussion](https://github.com/skygenesisenterprise/sso-service/discussions)
Or reach out to us at [contact@skygenesisenterprise.com](mailto:contact@skygenesisenterprise.com)

Thank you for helping improve SSO Enterprise Service 💌
